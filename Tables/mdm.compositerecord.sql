...
GO
ALTER TABLE [mdm].[compositerecord] ADD CONSTRAINT [PK_CompositeRecord_SSB_CRMSYSTEM_CONTACT_ID] PRIMARY KEY CLUSTERED  ([SSB_CRMSYSTEM_CONTACT_ID]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [NCIX_CompositeRecords_AddressFourIsCleanStatus] ON [mdm].[compositerecord] ([AddressFourIsCleanStatus]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [NCIX_CompositeRecords_AddressOneIsCleanStatus] ON [mdm].[compositerecord] ([AddressOneIsCleanStatus]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [NCIX_CompositeRecords_AddressPrimaryIsCleanStatus] ON [mdm].[compositerecord] ([AddressPrimaryIsCleanStatus]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [NCIX_CompositeRecords_AddressThreeIsCleanStatus] ON [mdm].[compositerecord] ([AddressThreeIsCleanStatus]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [NCIX_CompositeRecords_AddressTwoIsCleanStatus] ON [mdm].[compositerecord] ([AddressTwoIsCleanStatus]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [NCIX_CompositeRecords_CompanyName] ON [mdm].[compositerecord] ([CompanyName]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [NCIX_CompositeRecords_EmailOneIsCleanStatus] ON [mdm].[compositerecord] ([EmailOneIsCleanStatus]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [NCIX_CompositeRecords_EmailPrimaryIsCleanStatus] ON [mdm].[compositerecord] ([EmailPrimaryIsCleanStatus]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [NCIX_CompositeRecords_EmailTwoIsCleanStatus] ON [mdm].[compositerecord] ([EmailTwoIsCleanStatus]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [NCIX_CompositeRecords_PhoneBusinessIsCleanStatus] ON [mdm].[compositerecord] ([PhoneBusinessIsCleanStatus]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [NCIX_CompositeRecords_PhoneCellIsCleanStatus] ON [mdm].[compositerecord] ([PhoneCellIsCleanStatus]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [NCIX_CompositeRecords_PhoneFaxIsCleanStatus] ON [mdm].[compositerecord] ([PhoneFaxIsCleanStatus]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [NCIX_CompositeRecords_PhoneHomeIsCleanStatus] ON [mdm].[compositerecord] ([PhoneHomeIsCleanStatus]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [NCIX_CompositeRecords_PhoneOtherIsCleanStatus] ON [mdm].[compositerecord] ([PhoneOtherIsCleanStatus]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [NCIX_CompositeRecords_PhonePrimaryIsCleanStatus] ON [mdm].[compositerecord] ([PhonePrimaryIsCleanStatus]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [NCIX_mdmCompositeRecords_UpdatedDate_ACCTCONTACTIDs] ON [mdm].[compositerecord] ([UpdatedDate]) INCLUDE ([SSB_CRMSYSTEM_ACCT_ID], [SSB_CRMSYSTEM_CONTACT_ID], [SSB_CRMSYSTEM_HOUSEHOLD_ID]) WITH (DATA_COMPRESSION = PAGE)
GO

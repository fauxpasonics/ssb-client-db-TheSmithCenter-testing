...
GO
ALTER TABLE [dbo].[TK_PRTYPE] ADD CONSTRAINT [PK_TK_PRTYPE] PRIMARY KEY NONCLUSTERED  ([ETLSID], [SEASON], [PRTYPE])
GO
CREATE NONCLUSTERED INDEX [CLI_TK_PRTYPE__SEASON_PRTYPE] ON [dbo].[TK_PRTYPE] ([SEASON], [PRTYPE])
GO

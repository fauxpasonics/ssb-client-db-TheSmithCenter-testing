...
GO
ALTER TABLE [dbo].[Source_DimCustomer] ADD CONSTRAINT [PK_Source_DimCustomer_DimcustomerID] PRIMARY KEY CLUSTERED  ([DimCustomerId]) WITH (DATA_COMPRESSION = PAGE)
GO
ALTER TABLE [dbo].[Source_DimCustomer] ADD CONSTRAINT [UK_Source_DimCustomer_SSID_SourceSystem] UNIQUE NONCLUSTERED  ([SSID], [SourceSystem]) WITH (DATA_COMPRESSION = PAGE)
GO

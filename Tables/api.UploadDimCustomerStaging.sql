CREATE TABLE [api].[UploadDimCustomerStaging]
(
[SessionId] [uniqueidentifier] NULL,
[RecordCreateDate] [datetime] NULL CONSTRAINT [DF_UploadDimCustomerStaging_RecordCreateDate] DEFAULT (getdate()),
[Processed] [bit] NULL CONSTRAINT [DF_UploadDimCustomerStaging_Processed] DEFAULT ((0)),
...
[IsDeleted] [bit] NULL CONSTRAINT [DF_UploadDimCustomerStaging_IsDeleted] DEFAULT ((0))
)
WITH
(

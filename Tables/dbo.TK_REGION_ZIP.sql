...
GO
ALTER TABLE [dbo].[TK_REGION_ZIP] ADD CONSTRAINT [PK_TK_REGION_ZIP] PRIMARY KEY CLUSTERED  ([ETLSID], [REGION], [VMC])
GO
CREATE NONCLUSTERED INDEX [IDX_REGION] ON [dbo].[TK_REGION_ZIP] ([REGION])
GO

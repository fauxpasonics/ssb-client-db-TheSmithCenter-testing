...
/*
EXEC dbo.rptCust_Days_Out_Event_SSB_1 @Season = 'TSC1516', -- varchar(25)
    @EventType = 'BLV', -- varchar(128)
    @Event = 'R0922', -- varchar(25)
	@Venue = 'BWAY' -- varchar(25)

*/


CREATE PROCEDURE [dbo].[rptCust_Days_Out_Event_SSB_1]
    @Season VARCHAR(500)
...
--DECLARE @Event VARCHAR(500) = 'R0922'
--DECLARE @Venue VARCHAR(500) = 'BWAY'
        ...
        SELECT  a.SeasonCode
              ...
              , a.SeasonCode COLLATE SQL_Latin1_General_CP1_CS_AS
                + a.EventCode COLLATE SQL_Latin1_General_CP1_CS_AS AS 'SeasonEventGroup'
        FROM    #Temp a
              , #Temp b
              , vTK_Season sea
        WHERE   sea.SeasonCode = a.SeasonCode
                ...
                SELECT  Item
                FROM    [dbo].[SplitSSB](@EventType, ',') )
                AND a.EventCode COLLATE SQL_Latin1_General_CP1_CS_AS IN (
                SELECT  Item
                FROM    [dbo].[SplitSSB](@Event, ',') )

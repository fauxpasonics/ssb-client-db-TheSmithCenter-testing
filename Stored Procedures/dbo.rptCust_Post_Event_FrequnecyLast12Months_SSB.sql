...
/*
EXEC dbo.rptCust_Post_Event_FrequnecyLast12Months_SSB  @TYPE = 'ET', -- varchar(2)
    @GROUPING = 'BWAY', -- varchar(25)
    @Season = 'TSC1415' -- varchar(15)
*/


CREATE PROCEDURE [dbo].[rptCust_Post_Event_FrequnecyLast12Months_SSB]
    @TYPE AS VARCHAR(2)
    ...
    BEGIN
        ...
        INSERT  [dbo].[TempVariableTrap]
                SELECT  @Season + '|' + @TYPE + '|' + @GROUPING + '|'
                        + '|'
                      , GETDATE()
                      , 'PostEvent - FrequencyLast12MonthsEnter' 
...
--INTO [dbo].[TEMP_rptCust_Post_Event_FrequnecyLast12Months_SSB]
        ...
        INSERT  [dbo].[TempVariableTrap]
                SELECT  @Season + '|' + @TYPE + '|' + @GROUPING + '|'
                        + '|'
                      , GETDATE()
                      , 'PostEvent - FrequencyLast12MonthsExit' 

--SELECT * FROM [dbo].[TEMP_rptCust_Post_Event_FrequnecyLast12Months_SSB]

...
/*
EXEC dbo.rptCust_Days_Out_EventGroup_SSB_1 @Season = 'LVP1213', -- varchar(25)
...
CREATE PROCEDURE [dbo].[rptCust_Days_Out_EventGroup_SSB_1_Bkp]
    @Season VARCHAR(500)
...
AS
	...
	--	insert dbo.TempVariableTrap VALUES (@Season, @EventType, @EventGroup, @Venue,GETDATE() )
        ...
        SELECT  a.SeasonCode
              ...
              , a.FacilityCode
			  , a.SeasonCode COLLATE SQL_Latin1_General_CP1_CS_AS + a.EGroupCode COLLATE SQL_Latin1_General_CP1_CS_AS AS 'SeasonGroupCode'
        FROM    #Temp a
              , #Temp b
              , vTK_Season sea
              , vTK_EGroup egr
        WHERE   sea.SeasonCode = a.SeasonCode
                ...
                AND a.EgroupCode COLLATE SQL_Latin1_General_CP1_CS_AS IN (SELECT Item FROM [dbo].[SplitSSB] (@EventGroup,','))
